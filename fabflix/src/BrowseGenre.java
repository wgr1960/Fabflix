...
public class BrowseGenre extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			params.add(String.valueOf(request.getParameter("genre")));

			System.out.println("About to make a call to Search: ");
			List<Movie> movies = new ArrayList<Movie>();
			movies = SQLServices.getMoviesbyGenre(params.toArray(new String[params.size()]), dbcon); 
